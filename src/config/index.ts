...
export default {
	...
	MONGO_ATLAS_DBNAME = process.env.MONGO_ATLAS_DBNAME || 'your_db_name',
	MONGO_ATLAS_USER = process.env.MONGO_ATLAS_DBNAME || 'mongo_atlas_user',
	MONGO_ATLAS_PWD = process.env.MONGO_ATLAS_PWD || 'mongo_atlas_password',
